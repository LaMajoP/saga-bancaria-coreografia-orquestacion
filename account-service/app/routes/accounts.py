...
async def debit(account_id: str, request: MoneyOperationRequest) -> OperationResponse:
...
async def credit(account_id: str, request: MoneyOperationRequest) -> OperationResponse:
...
async def compensate_debit(account_id: str, request: MoneyOperationRequest) -> OperationResponse:
...
async def compensate_credit(account_id: str, request: MoneyOperationRequest) -> OperationResponse:
